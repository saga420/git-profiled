class GitProfiled < Formula
  ...
  if OS.mac?
    if Hardware::CPU.intel?
      url "https://github.com/saga420/git-profiled/releases/download/v#{version}/git-profiled_darwin-amd64"
      sha256 "2c7789bc26539e7b0949d889856275fd2958495f40ba73c5d6a89e862f0fc2f1"
    else
      url "https://github.com/saga420/git-profiled/releases/download/v#{version}/git-profiled_darwin-arm64"
      sha256 "77b9ef11805a13877685a71e7b221655a1ac358ce27ce44a18d4b3ca10c4ad98"
    end
  elsif OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/saga420/git-profiled/releases/download/v#{version}/git-profiled_linux-amd64"
      sha256 "422817289ccad9220f1c4ba548a8ab79144496a89148fd4e4974b41f0f428b48"
    else
      url "https://github.com/saga420/git-profiled/releases/download/v#{version}/git-profiled_linux-arm64"
